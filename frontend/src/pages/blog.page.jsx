                            ...
                            <div className="mt-12">
                                ...
                                <div className="flex max-sm:flex-col justify-between my-8">
                                    <div className="flex gap-5 items-start">
                                        ...
                                        <p className="capitalize hover:text-blue-500" style={{ color: "#095571ff" }}>{fullname}
                                            <br />@
      ...
      <BlogContent block={block} />
                            ...
                            {Array.isArray(similarBlogs) && (
                                similarBlogs.length > 0 ? (
                                    ...
                                    <p className="text-center text-gray-500">No similar blogs found</p>
                                )
                            )}
...

                    {
                        similarBlogs.map((blog, i) => {
                            ...
                            <BlogPostcard content={blog} author={personal_info}/></AnimationWrapper>
