...
import  { ManageDraftsBlogCard, ManagePublishedBlogsCard } from "../components/manage-blogcard.component";
            ...
            <InPageNavigation routes={["Published Blogs", "Drafts"]} defaultActiveIndex={ activeTab != 'draft' ? 0 : 1}>
                {
                    ...
                    <LoadMoreButton state={blogs} fetchDataFun={getBlogs} additionalParam={{ draft: false, deletedDocCount: blogs.deletedDocCount }}/>
                ...
                
                 {
                    ...
                    drafts.results.length ? <>
                    {
                        drafts.results.map((blog, i) => {
                            return <AnimationWrapper key={i} transition={{ delay: i *0.04}}>
                               <ManageDraftsBlogCard blog={{ ...blog, index: i, setStateFuc: setDrafts}} />
                            </AnimationWrapper>
                        })
                    }
                                        <LoadMoreButton state={drafts} fetchDataFun={getBlogs} additionalParam={{ draft: true, deletedDocCount: drafts.deletedDocCount }}/>
