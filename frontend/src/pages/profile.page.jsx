            ...
            
            {
                ...
                <section className="h-cover md:flex flex-row-reverse items-start gap-5 min-[1100px]:gap-12">
                    <div className="flex flex-col max-md:items-center gap-5 min-w-[250px] md:w-[50%] md:pl-8 md:border-l border-grey md:sticky md:top-[100px] md:py-10">
                        <img src={profile_img} className="w-48 h-48 bg-grey border-4 border-blue  rounded-full md:w-32 md:h-32"  style={{ borderColor: "#095571ff" }}/>
                        <h1 className="text-2xl text-bold font-medium" style={{ color: "#095571ff"}}>@{profile_username}</h1>
                        <p className="text-xl  underline capitalize h-6" style={{ color: "#131010ff" }}>{fullname}</p>
                        <p>{total_posts.toLocaleString()} Blogs - {total_reads.toLocaleString()} Reads</p>
                        <div className="flex gap-4 mt-4">
                            {
                                profileId == username ?
                                <Link to="/settings/edit-profile" className="btn-dark -mt-4 rounded-md"  >Edit Profile</Link>
                                : " "
                            }
                    ...
                    <div className="max-md:mt-12 w-full ">  
                        ...
                        <>
                            ...
                            <LoadMoreButton state={blogs} fetchDataFun={getBlogs}/>
                        </>
