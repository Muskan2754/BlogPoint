...
let { blog, blog: { _id, title, blog_id, activity: { total_likes, total_comments } = {}, author: { personal_info: { username: author_username } = {} } = {}, } = blog, setBlog, islikedByUser, setLikedByUser, setCommentsWrapper } = useContext(BlogContext)
        ...
        <div className="flex gap-6 justify-between">
            <div className="flex gap-3 items-center">
                ...
                className="w-10 h-10 rounded-full flex items-center justify-center bg-grey/80">
                    <i className="fi fi-rr-comment-dots text-xl hover:text-twitter" ></i>
                </button>
            ...
            <div className="flex gap-6 items-center">

                {
                    ...
                    <Link to={`/editor/${blog_id}`} className="underline hover:text-purple">Edit Blog</Link> : ""
                }
