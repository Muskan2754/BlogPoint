       ...
       <div className={"p-6 border-b border-grey border-l-black "  + (!seen ? " border-l-2" : "")
        ...
        <div className="flex gap-5 mb-3">
            ...
            <div className="w-full">
                <h1 className="font-medium text-xl text-dark-grey">
                    ...
                    <Link to={`/user/${username}`} className="mx-1 text-black undeline">@{username}</Link>
                    <span className="font-normal">
                        {
                            type == 'like' ? "liked your blog" :
                            type == 'comment' ? "commented_on" :
                            "replied on"
                        }
                    </span>
                </h1>
        ...
        <div className="ml-14 pl-5 mt-3 text-dark-grey flex gap-8">
...

            {
                ...
                <>
                    {
                        !reply ? <button className="underline hover:text-black" onClick={handleReply}>Reply</button> : ""
                    }
